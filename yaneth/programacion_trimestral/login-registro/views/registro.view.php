		...
		<div class="row">
			<div class="col-md-12">
				...
				<section class="body">
					...
					<div class="input-group">
					  	<span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
					  	<input class="form-control" type="password" placeholder="Repita su contraseña" name="password1">
					</div><br>
					<input type="submit" name="registro" class="btn btn-outline-primary btn-block">
				</section>
				</form>
