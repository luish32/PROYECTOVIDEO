...
<html class="html">
 <head>
  ...
  <title>Añadir Instructor - Programacion Trimestral</title>
  <!-- CSS -->
...
Muse.Utils.transformMarkupToFixBrowserProblems();/* body */
  ...
  <h1 class="text2 text-center" id="add">Añadir instructor</h1>
  ...
  <div class="panel-body">
    ...
    ?>
      <a style="color: white" href="gestionarIns.php" class="btn btn-danger"><i style="color: white" class="glyphicon glyphicon-arrow-left"></i>Volver</a>
    <form action="" method="post" id="registro"><br>
                    <div class="form-group">
                         <label for=""><strong>Nombres*</strong></label>
                        <input type="text"  class="form-control" name="nombres"  
                          placeholder="Nombres" data-validation="required" onkeyup="javascript:this.value=this.value.toUpperCase();" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="apellidos" data-validation="required" placeholder="Apellidos" onkeyup="javascript:this.value=this.value.toUpperCase();">
                    </div>
                    <hr>
